...
namespace UserModule_MANAGED_POWER___INPUT_F_X__V1_00
{
    public class UserModuleClass_MANAGED_POWER___INPUT_F_X__V1_00 : SplusObject
    {
            ...
            try
            {
                ...
                if ( Functions.TestForTrue  ( ( GNINITCOMPLETE)  ) ) 
                    ...
                    if ( Functions.TestForTrue  ( ( Functions.BoolToInt (X[ NLMAI ] .UshortValue == 0))  ) ) 
                        ...
                        if ( Functions.TestForTrue  ( ( Functions.BoolToInt ( (Functions.TestForTrue ( Functions.BoolToInt ( X[ NLMAI ] .UshortValue > 0 ) ) && Functions.TestForTrue ( Functions.BoolToInt ( X[ NLMAI ] .UshortValue <= 32 ) )) ))  ) ) 
                            { 
    ...
    public override void LogosSplusInitialize()
    {
        ...
        Y = new InOutArray<AnalogInput>( 32, this );
        for( uint i = 0; i < 32; i++ )
        {
    ...
    public UserModuleClass_MANAGED_POWER___INPUT_F_X__V1_00 ( string InstanceName, string ReferenceID, Crestron.Logos.SplusObjects.CrestronStringEncoding nEncodingType ) : base( InstanceName, ReferenceID, nEncodingType ) {}
    ...
    const uint X__AnalogSerialInput__ = 33;
